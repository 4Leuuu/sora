    ...
    return (
        <main className="relative">
            <div className="relative w-full">
                <div 
                    className="bg-center bg-cover inset-0 opacity-40 h-84 w-full" 
                    style={{ backgroundImage: `url(${anime?.bannerImage || anime?.coverImage?.extraLarge})` }}
                />
                <div className="absolute inset-0 bg-linear-to-t from-background via-background/60 to-transparent h-84" />
            </div>
            ...
            <div className="sticky bottom-0 w-full border-t bg-backgorund/80 backdrop-blur-md z-10">
                <div className="max-w-6xl mx-auto flex justify-between p-4">
                    <Button onClick={() => navigate("/")} variant="secondary"><ArrowLeft /> Voltar</Button>
                    <Button variant="destructive">Adicionar aos Favoritos</Button>
                </div>
            </div>
        </main>
    )
